...
require '../content/framework/PHPMailer/src/Exception.php';
require '../content/framework/PHPMailer/src/PHPMailer.php';
require '../content/framework/PHPMailer/src/SMTP.php';
...
if (isset($send_email) && $send_email == true) {
     ...
     try {
          ...
          //Recipients
          $mail->setFrom('maohiemgia3@gmail.com', 'Xshop');
